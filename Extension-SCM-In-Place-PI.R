...
prepare_p_ls_PI <- function(data){
  ...
  DATA_PM <- dataprep(foo = data,
                      ...
                      controls.identifier   = c(11:17, 21, 24:29, 31:33, 35, 41:43, 50:53), # Exclude PI (22) and CE (23) from controls
...
prepare_us_PI <- function(data){
  ...
  DATA_PM <- dataprep(foo = data,
                      ...
                      unit.names.variable = "abbr_state",
                      treatment.identifier  = 22, # Piauí Code
                      controls.identifier   = c(11:17, 21, 24:26, 28:29, 31:33, 35, 41:43, 50:53), # Exclude PI (22) and CE (23) from controls
